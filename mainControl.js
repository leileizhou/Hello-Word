define(['ganyijiapi','pagecontrol'],function(ganyiApi,pagecontrol) {
 	...
 	var index2Function = [{type:'chenshan'},{type:'wazi'},{type:'neiyi'},{type:'qita'}];
 	var index2FunctionClass = [{className:'fc_one'},{className:'fc_two'},{className:'fc_three'},{className:'fc_four'}];
